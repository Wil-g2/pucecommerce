...
<head>
  ...
  <title>Loja PUC | Dashboard</title>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <?php if ($this->session->userdata('tipo') != null) { ?>
          <a class="nav-link"  data-toggle="modal" data-target="#ModalLogout" href="#">Logout <i class="fa fa-close"></i></a><?php 
          } else { ?>    
                <a href='<?php echo base_url('login'); ?>' class="nav-link" > Login <i class="fa fa-lock"></i></a>                
            <?php } ?>
      </li>
    </ul>
  </nav>
