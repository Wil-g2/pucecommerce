...
*/
$route['default_controller'] = 'CatalogoController/list';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
...
$route['pessoaedit/(:num)'] = "PessoaController/editar/$1";
...
$route['enderecos/(:num)'] = "EnderecoController/listId/$1";
...
$route['catalogo'] = "CatalogoController/list";
...
$route['relpedidos'] = "PedidoController/loadRelPedidos";
$route['buscar_pedidos'] = "PedidoController/relPedidos";
//$route['acompanhar'] = "AcompanhamentoController/acompanhamentoList";
$route['acompanhar/(:num)'] = "AcompanhamentoController/acompanhamentoList/1$";
$route['getEvent'] = "AcompanhamentoController/getEventos";
$route['avaliar'] = "AvaliacaoController/add";
$route['chamados'] = "SacController/list";
$route['sacadd'] = "SacController/add";
$route['saclist'] = "SacController/list";
$route['sacedit/(:any)'] = "SacController/editar/$1";
$route['sacdel/(:any)'] = "SacController/excluir/$1";
$route['relsac'] = "SacController/relChamados";
$route['fornecedores'] = "FornecedorController/list";
$route['fornadd'] = "FornecedorController/add";
$route['fornedit/(:any)'] = "FornecedorController/editar/$1";
$route['forndel/(:any)'] = "FornecedorController/excluir/$1";
...
//$route['nuSoapServer/wsdl'] = 'nuSoapServer/index/wsdl';
$route['nuSoapServer'] = 'nuSoapServer';
